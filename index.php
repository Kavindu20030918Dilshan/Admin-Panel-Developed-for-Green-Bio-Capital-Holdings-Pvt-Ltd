...
<head>
  ...
  <title>Livendra Test Page - Index</title>
  ...
  <!-- =======================================================
  * Template Name: Livendra Test Page
  * Template URL: https://Livemdra Soft.com/free-bootstrap-app-landing-page-template/
  * Updated: Mar 17 2024 with Bootstrap v5.3.3
  * Author: Livemdra Soft.com
  * License: https://Livemdra Soft.com/license/
  ======================================================== -->
</head>
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Livendra Test Page</a></h1>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6 info">
                <i class="bx bx-map"></i>
                <h4>Address</h4>
                <p>No 100,<br>NAwalapitiya ,Kandy . 20650</p>
              </div>
              <div class="col-lg-6 info">
                <i class="bx bx-phone"></i>
                <h4>Call Us</h4>
                <p>+94 77 348 2917<br>+94 76 756 6508</p>
              </div>
              <div class="col-lg-6 info">
                <i class="bx bx-envelope"></i>
                <h4>Email Us</h4>
                <p>contact@livendrasoft.com<br>info@livendrasoft.com</p>
              </div>
              <div class="col-lg-6 info">
                <i class="bx bx-time-five"></i>
                <h4>Working Hours</h4>
                <p> 9AM to 5PM<br>Every Day</p>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Livendra Test Page</h3>
            <p>
              No : 100 <br>
              Nawalapitiya, Kandy<br>
              Sri Lanka. <br><br>
              <strong>Phone:</strong>  +94 76 756 6508<br>
              <strong>Phone:</strong>  +94 77 348 2917<br>
              <strong>Email:</strong> info@livendrasoft.com<br>
            </p>
          </div>
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>©️Livendra Test Page</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you purchased the pro version. -->
        <!-- Licensing information: https://Livemdra Soft.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://Livemdra Soft.com/free-bootstrap-app-landing-page-template/ -->
        Designed by <a href="https://Livemdra Soft.com/">Livemdra Soft</a>
      </div>
    </div>
  </footer><!-- End Footer -->
